...
this script returns output to stdout - careful!
'''
...
def args():
    ...
    return args.filename, int(args.windowsize)
...
def main():
    infile, windowsize = args()
    ld_calc(infile, windowsize)
